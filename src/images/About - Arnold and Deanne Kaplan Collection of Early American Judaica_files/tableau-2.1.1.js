...
(function () {
  ...
  (function (global) {
    ...
    ss_Int32.getDefaultValue = ss_Int32.createInstance =
      function Int32$getDefaultValue() {
        return 0;
      };
  ...
  (function () {
    ...
    $tab_WindowHelper.getPathAndSearch = function WindowHelper$GetPathAndSearch(
      window,
    ) {
      return window.location.pathname + window.location.search;
    };
    $tab_WindowHelper.setLocationHref = function WindowHelper$SetLocationHref(
      window,
      href,
    ) {
      window.location.href = href;
    };
    $tab_WindowHelper.locationReplace = function WindowHelper$LocationReplace(
      window,
      url,
    ) {
    ...
    $tab_WindowHelper.requestAnimationFrame =
      function WindowHelper$RequestAnimationFrame(action) {
        return $tab_WindowHelper.$requestAnimationFrameFunc(action);
      };
    $tab_WindowHelper.cancelAnimationFrame =
      function WindowHelper$CancelAnimationFrame(animationId) {
        if (ss.isValue(animationId)) {
          $tab_WindowHelper.$cancelAnimationFrameFunc(animationId);
        }
      };
    $tab_WindowHelper.setTimeout = function WindowHelper$SetTimeout(
      callback,
      milliseconds,
    ) {
      return window.setTimeout(callback, milliseconds);
    };
    $tab_WindowHelper.addListener = function WindowHelper$AddListener(
      windowParam,
      eventName,
      messageListener,
    ) {
    ...
    $tab_WindowHelper.removeListener = function WindowHelper$RemoveListener(
      window,
      eventName,
      messageListener,
    ) {
  ...
  (function () {
    ...
    $tab_$DeferredUtil.$coerceToTrustedPromise =
      function DeferredUtil$CoerceToTrustedPromise(promiseOrValue) {
        var promise;
    ...
    $tab_$DeferredUtil.$isPromise = function DeferredUtil$IsPromise(
      promiseOrValue,
    ) {
      return (
        ss.isValue(promiseOrValue) &&
    ...
    $tab_$DoNothingCrossDomainHandler.__typeName =
      "tab.$DoNothingCrossDomainHandler";
    ////////////////////////////////////////////////////////////////////////////////
    // tableauSoftware.FilterEventContext
    var $tab_$FilterEventContext = function (
      workbookImpl,
      worksheetImpl,
      fieldFieldName,
      filterCaption,
    ...
    $tab_$MarkImpl.$processActiveMarks = function MarkImpl$ProcessActiveMarks(
      marksPresModel,
    ) {
    ...
    var $tab_$ParameterImpl = function (pm) {
      ...
      this.$dataType = $tab_ApiEnumConverter.convertParameterDataType(
        pm.dataType,
      );
      this.$allowableValuesType =
        $tab_ApiEnumConverter.convertParameterAllowableValuesType(
      ...
      if (this.$allowableValuesType === "range") {
        ...
        if (
          ...
          this.$dateStepPeriod = $tab_ApiEnumConverter.convertPeriodType(
            pm.dateStepPeriod,
          );
        }
      }
    ...
    $tab_$PublicEnums.$normalizeEnum = function (T) {
      return function PublicEnums$NormalizeEnum(rawValue, paramName) {
        var value = {};
        if (
          !$tab_$PublicEnums.$tryNormalizeEnum(T).call(null, rawValue, value)
        ) {
    ...
    $tab__ApiCommand.generateNextCommandId =
      function ApiCommand$GenerateNextCommandId() {
    ...
    $tab__ApiObjectRegistry.registerCrossDomainMessageRouter =
      function ApiObjectRegistry$RegisterCrossDomainMessageRouter(
        objectCreationFunc,
      ) {
        return $tab__ApiObjectRegistry
          .$registerType($tab_ICrossDomainMessageRouter)
          .call(null, objectCreationFunc);
      };
    $tab__ApiObjectRegistry.getCrossDomainMessageRouter =
      function ApiObjectRegistry$GetCrossDomainMessageRouter() {
        return $tab__ApiObjectRegistry
          .$getSingleton($tab_ICrossDomainMessageRouter)
          .call(null);
      };
    $tab__ApiObjectRegistry.disposeCrossDomainMessageRouter =
      function ApiObjectRegistry$DisposeCrossDomainMessageRouter() {
        $tab__ApiObjectRegistry
          .$clearSingletonInstance($tab_ICrossDomainMessageRouter)
          .call(null);
      };
    $tab__ApiObjectRegistry.$registerType = function (T) {
      return function ApiObjectRegistry$RegisterType(objectCreationFunc) {
        ...
        var previousType =
          $tab__ApiObjectRegistry.$creationRegistry[interfaceTypeName];
        $tab__ApiObjectRegistry.$creationRegistry[interfaceTypeName] =
          objectCreationFunc;
        return previousType;
      };
    ...
    $tab__ApiObjectRegistry.$getSingleton = function (T) {
      return function ApiObjectRegistry$GetSingleton() {
        ...
        var instance = ss.cast(
          $tab__ApiObjectRegistry.$singletonInstanceRegistry[interfaceTypeName],
          T,
        );
    ...
    $tab__ApiObjectRegistry.$clearSingletonInstance = function (T) {
      return function ApiObjectRegistry$ClearSingletonInstance() {
        ...
        delete $tab__ApiObjectRegistry.$singletonInstanceRegistry[
          interfaceTypeName
        ];
        return instance;
      };
    ...
    var $tab__ApiServerNotification = function (
      workbookName,
      worksheetName,
      data,
    ) {
    ...
    $tab__ApiServerNotification.deserialize =
      function ApiServerNotification$Deserialize(json) {
    ...
    $tab__CustomViewImpl._getAsync = function CustomViewImpl$GetAsync(
      eventContext,
    ) {
    ...
    $tab__CustomViewImpl._createNew = function CustomViewImpl$CreateNew(
      workbookImpl,
      messagingOptions,
      apiPresModel,
      defaultId,
    ...
    $tab__CustomViewImpl._saveNewAsync = function CustomViewImpl$SaveNewAsync(
      workbookImpl,
      messagingOptions,
      name,
    ) {
    ...
    $tab__CustomViewImpl._showCustomViewAsync =
      function CustomViewImpl$ShowCustomViewAsync(
        workbookImpl,
        messagingOptions,
    ...
    $tab__CustomViewImpl._makeCurrentCustomViewDefaultAsync =
    ...
    $tab__CustomViewImpl._getCustomViewsAsync =
      function CustomViewImpl$GetCustomViewsAsync(
        workbookImpl,
        messagingOptions,
      ) {
        var deferred = new tab._Deferred();
        var returnHandler = new (ss.makeGenericType(
          ...
          function (remoteError, message) {
            deferred.reject(
              $tab__TableauException.create("serverError", message),
            );
          },
        );
        messagingOptions
    ...
    $tab__CustomViewImpl._processCustomViews =
      function CustomViewImpl$ProcessCustomViews(
        workbookImpl,
        messagingOptions,
        info,
      ) {
    ...
    $tab__CustomViewImpl._processCustomViewUpdate =
      function CustomViewImpl$ProcessCustomViewUpdate(
        workbookImpl,
        messagingOptions,
        info,
        doUpdateList,
        ...
        if (doUpdateList && ss.isValue(info.newView)) {
          var newViewImpl = $tab__CustomViewImpl._createNew(
            workbookImpl,
            messagingOptions,
            info.newView,
            defaultId,
          ...
          workbookImpl
            ...
            ._add(newViewImpl.get_$name(), newViewImpl.get_$customView());
        }
            ...
            for (var i = 0; i < list.length; i++) {
              ...
              if (
                workbookImpl
                  ...
                  ._has(customViewImpl.get_$name())
              ) {
                workbookImpl
                  .get_$removedCustomViews()
                  ._remove(customViewImpl.get_$name());
    ...
    $tab__CustomViewImpl.$createCustomViewCommandReturnHandler =
      function CustomViewImpl$CreateCustomViewCommandReturnHandler(
        ...
        return new (ss.makeGenericType($tab_CommandReturnHandler$1, [Object]))(
          commandName,
          0,
          successCallback,
          errorCallback,
    ...
    var $tab__DashboardImpl = function (
      sheetInfoImpl,
      workbookImpl,
      messagingOptions,
    ) {
    ...
    $tab__DataSourceImpl.processDataSource =
      function DataSourceImpl$ProcessDataSource(dataSourcePm) {
        ...
        for (var $t1 = 0; $t1 < fields.length; $t1++) {
          ...
          var fieldAggregation = $tab_ApiEnumConverter.convertFieldAggregation(
            fieldPm.aggregation,
          );
    ...
    $tab__DataSourceImpl.processDataSourcesForWorksheet =
    ...
    var $tab__DataTableImpl = function (
      rows,
      isSummaryData,
      totalRowCount,
      columns,
    ...
    $tab__DataTableImpl.processGetDataPresModel =
      function DataTableImpl$ProcessGetDataPresModel(model) {
        var clientTable = $tab__DataTableImpl.$processUnderlyingTable(
          model.dataTable,
        );
        var clientColumns = $tab__DataTableImpl.$processUnderlyingColumns(
          model.headers,
        );
    ...
    $tab__DataTableImpl.$processUnderlyingTable =
      function DataTableImpl$ProcessUnderlyingTable(apiTable) {
        var clientTable = [];
    ...
    $tab__DataTableImpl.$processUnderlyingColumns =
      function DataTableImpl$ProcessUnderlyingColumns(apiColumns) {
        var clientColumns = [];
    ...
    $tab__Param.verifyString = function Param$VerifyString(
      argumentValue,
      argumentName,
    ) {
    ...
    $tab__Param.verifyValue = function Param$VerifyValue(
      argumentValue,
      argumentName,
    ) {
    ...
    $tab__SheetImpl.$convertValueToIntIfValid =
      function SheetImpl$ConvertValueToIntIfValid(value) {
        if (ss.isValue(value)) {
          return $tab__Utility.toInt(value);
        }
        return value;
      };
    $tab__SheetImpl.$normalizeSheetSize = function SheetImpl$NormalizeSheetSize(
      size,
    ) {
      var behavior = $tab_$PublicEnums
        .$normalizeEnum($tab_ApiSheetSizeBehavior)
        .call(null, size.behavior, "size.behavior");
      var minSize = size.minSize;
      if (ss.isValue(minSize)) {
        minSize = $tab_Size.$ctor(
    ...
    $tab__SheetInfoImpl.$ctor = function (
      name,
      sheetType,
      index,
      size,
    ...
    var $tab__StoryPointImpl = function (
      storyPointInfoImpl,
      containedSheetImpl,
    ) {
      this.$caption = null;
    ...
    $tab__StoryPointImpl.createContainedSheet =
      function StoryPointImpl$CreateContainedSheet(
        containedSheetInfo,
        workbookImpl,
        messagingOptions,
        findSheetFunc,
      ) {
        var containedSheetType = $tab_ApiEnumConverter.convertSheetType(
    ...
    $tab__StoryPointInfoImpl.$ctor = function (
      caption,
      index,
      storyPointId,
      isActive,
    ...
    $tab__TableauException.create = function TableauException$Create(
      id,
      message,
    ) {
    ...
    $tab__TableauException.createInternalError =
      function TableauException$CreateInternalError(details) {
    ...
    $tab__TableauException.createInternalNullArgumentException =
    ...
    $tab__TableauException.createInternalStringArgumentException =
    ...
    $tab__TableauException.createServerError =
      function TableauException$CreateServerError(message) {
        return $tab__TableauException.create("serverError", message);
      };
    $tab__TableauException.createNotActiveSheet =
      function TableauException$CreateNotActiveSheet() {
        return $tab__TableauException.create(
          "notActiveSheet",
          "Operation not allowed on non-active sheet",
        );
      };
    $tab__TableauException.createInvalidCustomViewName =
    ...
    $tab__TableauException.createInvalidParameter =
      function TableauException$CreateInvalidParameter(paramName) {
        return $tab__TableauException.create(
          "invalidParameter",
    ...
    $tab__TableauException.createInvalidFilterFieldNameOrValue =
      function TableauException$CreateInvalidFilterFieldNameOrValue(fieldName) {
        return $tab__TableauException.create(
          "invalidFilterFieldNameOrValue",
          "Invalid filter field name or value: " + fieldName,
        );
      };
    $tab__TableauException.createInvalidDateParameter =
    ...
    $tab__TableauException.createNullOrEmptyParameter =
    ...
    $tab__TableauException.createMissingMaxSize =
      function TableauException$CreateMissingMaxSize() {
        return $tab__TableauException.create(
          "missingMaxSize",
          "Missing maxSize for SheetSizeBehavior.ATMOST",
        );
      };
    $tab__TableauException.createMissingMinSize =
      function TableauException$CreateMissingMinSize() {
        return $tab__TableauException.create(
          "missingMinSize",
          "Missing minSize for SheetSizeBehavior.ATLEAST",
        );
      };
    $tab__TableauException.createMissingMinMaxSize =
    ...
    $tab__TableauException.createInvalidRangeSize =
    ...
    $tab__TableauException.createInvalidSizeValue =
    ...
    $tab__TableauException.createInvalidSheetSizeParam =
    ...
    $tab__TableauException.createSizeConflictForExactly =
    ...
    $tab__TableauException.createInvalidSizeBehaviorOnWorksheet =
    ...
    $tab__TableauException.createNoUrlForHiddenWorksheet =
    ...
    $tab__TableauException.$createInvalidAggregationFieldName =
    ...
    $tab__TableauException.createIndexOutOfRange =
      function TableauException$CreateIndexOutOfRange(index) {
        return $tab__TableauException.create(
          "indexOutOfRange",
          "Index '" + index + "' is out of range.",
        );
      };
    $tab__TableauException.createUnsupportedEventName =
    ...
    $tab__TableauException.createBrowserNotCapable =
    ...
    $tab__Utility.indexOf = function Utility$IndexOf(
      array,
      searchElement,
      fromIndex,
    ) {
    ...
    $tab__Utility.contains = function Utility$Contains(
      array,
      searchElement,
      fromIndex,
    ) {
    ...
    $tab__Utility.findParentWithClassName =
      function Utility$FindParentWithClassName(
        element,
        className,
        stopAtElement,
      ) {
    ...
    $tab__Utility.hasWindowPostMessage =
      function Utility$HasWindowPostMessage() {
        return !!ss.isValue(window.postMessage);
      };
    $tab__Utility.isPostMessageSynchronous =
      function Utility$IsPostMessageSynchronous() {
    ...
    $tab__Utility.hasDocumentAttachEvent =
      function Utility$HasDocumentAttachEvent() {
        return !!ss.isValue(document.attachEvent);
      };
    $tab__Utility.hasWindowAddEventListener =
      function Utility$HasWindowAddEventListener() {
        return !!ss.isValue(window.addEventListener);
      };
    $tab__Utility.isElementOfTag = function Utility$IsElementOfTag(
      element,
      tagName,
    ) {
      return (
        ss.isValue(element) &&
        element.nodeType === 1 &&
        ss.referenceEquals(element.tagName.toLowerCase(), tagName.toLowerCase())
      );
    };
    ...
    $tab__Utility.visibleContentRectInDocumentCoordinates =
    ...
    $tab__Utility.contentRectInDocumentCoordinates =
    ...
    $tab__Utility.getBoundingClientRect =
      function Utility$GetBoundingClientRect(element) {
    ...
    $tab__Utility.convertRawValue = function Utility$ConvertRawValue(
      rawValue,
      dataType,
    ) {
    ...
    $tab__Utility.serializeDateForServer =
      function Utility$SerializeDateForServer(date) {
        var serializedDate = "";
    ...
    $tab__Utility.computeContentSize = function Utility$ComputeContentSize(
      element,
    ) {
      var style = $tab__Utility.$getComputedStyle(element);
    ...
    $tab__Utility.$getComputedStyle = function Utility$GetComputedStyle(
      element,
    ) {
      if (typeof window["getComputedStyle"] === "function") {
    ...
    $tab__Utility.roundVizSizeInPixels = function Utility$RoundVizSizeInPixels(
      size,
    ) {
    ...
    $tab__VizManagerImpl.get_$clonedVizs =
      function VizManagerImpl$get_ClonedVizs() {
        return $tab__VizManagerImpl.$vizs.concat();
      };
    $tab__VizManagerImpl.$registerViz = function VizManagerImpl$RegisterViz(
      viz,
    ) {
      $tab__VizManagerImpl.$verifyVizNotAlreadyParented(viz);
      $tab__VizManagerImpl.$vizs.push(viz);
    };
    $tab__VizManagerImpl.$unregisterViz = function VizManagerImpl$UnregisterViz(
      viz,
    ) {
    ...
    $tab__VizManagerImpl.$sendVisibleRects =
      function VizManagerImpl$SendVisibleRects() {
        for (var i = 0, len = $tab__VizManagerImpl.$vizs.length; i < len; i++) {
          $tab__VizManagerImpl.$vizs[i]._impl.$sendVisibleRect();
        }
      };
    $tab__VizManagerImpl.$verifyVizNotAlreadyParented =
        ...
        for (var i = 0, len = $tab__VizManagerImpl.$vizs.length; i < len; i++) {
          if (
            ...
            var message =
              ...
              $tab__Utility.elementToString(parent) +
              "'.";
    ...
    var $tab__VizParameters = function (element, url, options) {
      ...
      if (ss.isValue(options.height) || ss.isValue(options.width)) {
        ...
        this.height = ss.isValue(options.height)
          ? $tab__Utility.roundVizSizeInPixels(options.height.toString())
          : null;
        this.width = ss.isValue(options.width)
          ? $tab__Utility.roundVizSizeInPixels(options.width.toString())
          : null;
      } else {
        this.fixedSize = false;
      }
    ...
    $tab__WorkbookImpl.$createDashboardZones =
      function WorkbookImpl$CreateDashboardZones(zones) {
        zones = ss.coalesce(zones, []);
        var zonesInfo = [];
        for (var i = 0; i < zones.length; i++) {
          var zone = zones[i];
          var objectType = $tab_ApiEnumConverter.convertDashboardObjectType(
            zone.zoneType,
          );
    ...
    $tab__WorkbookImpl.$extractSheetName =
      function WorkbookImpl$ExtractSheetName(sheetOrInfoOrName) {
    ...
    $tab__WorkbookImpl.$createSheetSize = function WorkbookImpl$CreateSheetSize(
      sheetInfo,
    ) {
      if (ss.isNullOrUndefined(sheetInfo)) {
        return $tab_SheetSizeFactory.createAutomatic();
      }
      return $tab_SheetSizeFactory.fromSizeConstraints(
        sheetInfo.sizeConstraints,
      );
    };
    $tab__WorkbookImpl.$processParameters =
      function WorkbookImpl$ProcessParameters(paramList) {
    ...
    $tab__WorkbookImpl.$findAndCreateParameterImpl =
    ...
    var $tab__WorksheetImpl = function (
      sheetInfoImpl,
      workbookImpl,
      messagingOptions,
      parentDashboardImpl,
    ...
    $tab__WorksheetImpl.$filterCommandError =
      function WorksheetImpl$FilterCommandError(rawPm) {
    ...
    $tab__WorksheetImpl.$normalizeRangeFilterOption =
      function WorksheetImpl$NormalizeRangeFilterOption(filterOptions) {
        ...
        if (ss.isValue(filterOptions.nullOption)) {
          fixedUpFilterOptions.nullOption = $tab_$PublicEnums
            .$normalizeEnum($tab_ApiNullOption)
            .call(null, filterOptions.nullOption, "filterOptions.nullOption");
        }
        return fixedUpFilterOptions;
      };
    $tab__WorksheetImpl.$normalizeRelativeDateFilterOptions =
      function WorksheetImpl$NormalizeRelativeDateFilterOptions(filterOptions) {
        if (ss.isNullOrUndefined(filterOptions)) {
          throw $tab__TableauException.createNullOrEmptyParameter(
            "filterOptions",
          );
        ...
        var fixedUpFilterOptions = new Object();
        fixedUpFilterOptions.rangeType = $tab_$PublicEnums
          .$normalizeEnum($tab_ApiDateRangeType)
          .call(null, filterOptions.rangeType, "filterOptions.rangeType");
        fixedUpFilterOptions.periodType = $tab_$PublicEnums
    ...
    $tab__WorksheetImpl.$createFilterCommandReturnHandler =
      function WorksheetImpl$CreateFilterCommandReturnHandler(
        commandName,
        fieldName,
        deferred,
      ) {
    ...
    $tab__WorksheetImpl.$createSelectionCommandError =
    ...
    $tab_ApiEnumConverter.convertDashboardObjectType =
    ...
    $tab_ApiEnumConverter.convertDateRange =
      function ApiEnumConverter$ConvertDateRange(crossDomainType) {
        switch (crossDomainType) {
          case "curr": {
            return "curr";
          }
    ...
    $tab_ApiEnumConverter.convertFieldAggregation =
    ...
    $tab_ApiEnumConverter.convertFieldRole =
      function ApiEnumConverter$ConvertFieldRole(crossDomainType) {
        switch (crossDomainType) {
          case "dimension": {
            return "dimension";
          }
    ...
    $tab_ApiEnumConverter.convertFilterType =
      function ApiEnumConverter$ConvertFilterType(crossDomainType) {
        switch (crossDomainType) {
          case "categorical": {
            return "categorical";
          }
    ...
    $tab_ApiEnumConverter.convertParameterDataType =
    ...
    $tab_ApiEnumConverter.convertPeriodType =
      function ApiEnumConverter$ConvertPeriodType(crossDomainType) {
        switch (crossDomainType) {
          case "year": {
            return "year";
          }
    ...
    $tab_ApiEnumConverter.convertSheetType =
      function ApiEnumConverter$ConvertSheetType(crossDomainType) {
        switch (crossDomainType) {
          case "worksheet": {
            return "worksheet";
          }
    ...
    $tab_ApiEnumConverter.convertDataType =
      function ApiEnumConverter$ConvertDataType(crossDomainType) {
        switch (crossDomainType) {
          case "boolean": {
            return "boolean";
          }
    ...
    $tab_ApiParameterAllowableValuesType.__typeName =
      "tab.ApiParameterAllowableValuesType";
    global.tab.ApiParameterAllowableValuesType =
      $tab_ApiParameterAllowableValuesType;
    ////////////////////////////////////////////////////////////////////////////////
    ...
    $tab_CrossDomainMessagingOptions.__typeName =
    ...
    $tab_ICrossDomainMessageHandler.__typeName =
      "tab.ICrossDomainMessageHandler";
    ...
    $tab_SheetSizeFactory.createAutomatic =
      function SheetSizeFactory$CreateAutomatic() {
        var size = $tab_SheetSize.$ctor("automatic", null, null);
        return size;
      };
    $tab_SheetSizeFactory.fromSizeConstraints =
      function SheetSizeFactory$FromSizeConstraints(vizSizePresModel) {
    ...
    $tab_StoryPointInfoImplUtil.clone = function StoryPointInfoImplUtil$Clone(
      impl,
    ) {
    ...
    var $tab_StoryPointSwitchEvent = function (
      eventName,
      viz,
      oldStoryPointInfo,
      newStoryPoint,
    ...
    var $tab_VizImpl = function (
      ...
      if (
        !$tab__Utility.hasWindowPostMessage() ||
        !$tab__Utility.hasJsonParse()
      ) {
        throw $tab__TableauException.createBrowserNotCapable();
      }
      this.$messagingOptions = new $tab_CrossDomainMessagingOptions(
        messageRouter,
        this,
      );
      this.$viz = viz;
    ...
    $tableauSoftware_CategoricalFilter.__typeName =
      "tableauSoftware.CategoricalFilter";
    global.tableauSoftware.CategoricalFilter =
      $tableauSoftware_CategoricalFilter;
    ////////////////////////////////////////////////////////////////////////////////
    ...
    var $tableauSoftware_DashboardObject = function (
      frameInfo,
      dashboard,
      worksheet,
    ) {
    ...
    $tableauSoftware_DashboardObject.__typeName =
      "tableauSoftware.DashboardObject";
    ...
    var $tableauSoftware_Field = function (
      dataSource,
      name,
      fieldRoleType,
      fieldAggrType,
    ...
    $tableauSoftware_Filter.$createFilter = function Filter$CreateFilter(
      worksheetImpl,
      pm,
    ) {
    ...
    $tableauSoftware_Filter.processFiltersList =
      function Filter$ProcessFiltersList(worksheetImpl, filtersListDict) {
    ...
    $tableauSoftware_HierarchicalFilter.__typeName =
      "tableauSoftware.HierarchicalFilter";
    global.tableauSoftware.HierarchicalFilter =
      $tableauSoftware_HierarchicalFilter;
    ////////////////////////////////////////////////////////////////////////////////
    ...
    $tableauSoftware_QuantitativeFilter.__typeName =
      "tableauSoftware.QuantitativeFilter";
    global.tableauSoftware.QuantitativeFilter =
      $tableauSoftware_QuantitativeFilter;
    ////////////////////////////////////////////////////////////////////////////////
    ...
    $tableauSoftware_RelativeDateFilter.__typeName =
      "tableauSoftware.RelativeDateFilter";
    global.tableauSoftware.RelativeDateFilter =
      $tableauSoftware_RelativeDateFilter;
    ////////////////////////////////////////////////////////////////////////////////
    ...
    $tableauSoftware_StoryPointInfo.__typeName =
      "tableauSoftware.StoryPointInfo";
    ...
    $tableauSoftware_Viz.getLastRequestMessage =
      function Viz$GetLastRequestMessage() {
        return $tab__ApiCommand.lastRequestMessage;
      };
    $tableauSoftware_Viz.getLastResponseMessage =
      function Viz$GetLastResponseMessage() {
        return $tab__ApiCommand.lastResponseMessage;
      };
    $tableauSoftware_Viz.getLastClientInfoResponseMessage =
    ...
    ss.initInterface($tab_ICrossDomainMessageRouter, $asm, {
      registerHandler: null,
      unregisterHandler: null,
      sendCommand: null,
    });
    ss.initClass(
      $tab_$CrossDomainMessageRouter,
      $asm,
      {
        registerHandler: function CrossDomainMessageRouter$RegisterHandler(
          handler,
        ) {
          var uniqueId = "handler" + this.$nextHandlerId;
          if (
            ss.isValue(handler.get_handlerId()) ||
            ss.isValue(this.$handlers[handler.get_handlerId()])
          ) {
            throw $tab__TableauException.createInternalError(
              "Handler '" +
                handler.get_handlerId() +
        ...
        unregisterHandler: function CrossDomainMessageRouter$UnregisterHandler(
          handler,
        ) {
          if (
            ss.isValue(handler.get_handlerId()) ||
        ...
        sendCommand: function (T) {
          return function CrossDomainMessageRouter$SendCommand(
            source,
            commandParameters,
            returnHandler,
          ) {
            ...
            if (commandName === "api.ShowCustomViewCommand") {
              var customViewCallbacks =
                this.$customViewLoadCallbacks[handlerId];
        ...
        $handleCustomViewsListLoad:
          function CrossDomainMessageRouter$HandleCustomViewsListLoad(source) {
            var handlerId = source.get_handlerId();
        ...
        $handleStateReadyForQuery:
          function CrossDomainMessageRouter$HandleStateReadyForQuery(source) {
            var queue =
              this.$commandReturnAfterStateReadyQueues[source.get_handlerId()];
        ...
        $handleCrossDomainMessage:
          function CrossDomainMessageRouter$HandleCrossDomainMessage(e) {
        ...
        $handleCrossDomainResponse:
          function CrossDomainMessageRouter$HandleCrossDomainResponse(command) {
            var commandCallbackMap =
              this.$commandCallbacks[command.get_handlerId()];
        ...
        $handleLegacyNotifications:
          function CrossDomainMessageRouter$HandleLegacyNotifications(
            messageName,
            handler,
          ) {
    ...
    ss.initInterface($tab_ICrossDomainMessageHandler, $asm, {
    ...
    ss.initClass(
      $tab_$DoNothingCrossDomainHandler,
      $asm,
      {
        add_customViewsListLoad:
          function DoNothingCrossDomainHandler$add_CustomViewsListLoad(value) {
            this.$1$CustomViewsListLoadField = ss.delegateCombine(
              this.$1$CustomViewsListLoadField,
              value,
            );
          },
        remove_customViewsListLoad:
          function DoNothingCrossDomainHandler$remove_CustomViewsListLoad(
            value,
          ) {
        ...
        remove_stateReadyForQuery:
          function DoNothingCrossDomainHandler$remove_StateReadyForQuery(
            value,
          ) {
        ...
        set_handlerId: function DoNothingCrossDomainHandler$set_HandlerId(
          value,
        ) {
        ...
        handleVizListening:
          function DoNothingCrossDomainHandler$HandleVizListening() {},
      ...
      null,
      [$tab_ICrossDomainMessageHandler],
    );
    ss.initClass(
      $tab_$FilterEventContext,
      $asm,
      {
        get__filterFieldName:
          function FilterEventContext$get_FilterFieldName() {
    ...
    ss.initClass($tab__CustomViewImpl, $asm, {
      ...
      $isDifferent: function CustomViewImpl$IsDifferent(other) {
        return (
          !ss.referenceEquals(this.$ownerName, other.$ownerName) ||
          !ss.referenceEquals(this.$url, other.$url) ||
    ...
    ss.initClass($tab__SheetImpl, $asm, {
      ...
      $processSheetSize: function SheetImpl$ProcessSheetSize(newSize) {
        ...
        if (newSize.behavior === "automatic") {
          fixedSheetSize = $tab_SheetSize.$ctor(
            "automatic",
            undefined,
            undefined,
          );
          ...
          fixedSheetSize = $tab_SheetSize.$ctor(
            "exactly",
            $tab_Size.$ctor(minWidth, minHeight),
            $tab_Size.$ctor(maxWidth, maxHeight),
          );
        }
    ...
    ss.initClass(
      ...
      $asm,
      {
        add_activeStoryPointChange:
          function StoryImpl$add_ActiveStoryPointChange(value) {
        ...
        get_activeStoryPointImpl:
          function StoryImpl$get_ActiveStoryPointImpl() {
        ...
        activateStoryPointAsync: function StoryImpl$ActivateStoryPointAsync(
          ...
          var returnHandler = new (ss.makeGenericType(
            ...
            function (remoteError, errorMessage) {
              deferred.reject(
                $tab__TableauException.createServerError(errorMessage),
              );
            },
          );
        ...
        $activatePreviousNextStoryPointAsync:
          function StoryImpl$ActivatePreviousNextStoryPointAsync(commandName) {
            ...
            var deferred = new tab._Deferred();
            var previouslyActiveStoryPointImpl =
              this.get_activeStoryPointImpl();
            var commandParameters = {};
            var returnHandler = new (ss.makeGenericType(
              $tab_CommandReturnHandler$1,
              [Object],
        ...
        $updateActiveState: function StoryImpl$UpdateActiveState(
          previouslyActiveStoryPointImpl,
          ...
          var newStoryPointInfoImpl =
            this.$storyPointsInfo[newActiveIndex]._impl;
          var containedSheetImpl = $tab__StoryPointImpl.createContainedSheet(
    ...
    ss.initClass($tab__WorkbookImpl, $asm, {
      ...
      $createSheetsInfo: function WorkbookImpl$CreateSheetsInfo(clientInfo) {
        ...
        for (var index = 0; index < baseSheets.length; index++) {
          ...
          if (ss.isNullOrUndefined(sheetInfo)) {
            ...
            var sheetType = $tab_ApiEnumConverter.convertSheetType(
              baseSheet.sheetType,
            );
            var sheetInfoImpl = $tab__SheetInfoImpl.$ctor(
              sheetName,
      ...
      $showCustomViewAsync: function WorkbookImpl$ShowCustomViewAsync(
        ...
        if (
          ...
          $tab__Utility.isNullOrEmpty(customViewName)
        ) {
          return $tab__CustomViewImpl._showCustomViewAsync(
            this,
            this.$messagingOptions,
      ...
      $removeCustomViewAsync: function WorkbookImpl$RemoveCustomViewAsync(
        ...
        if (ss.isNullOrUndefined(cv)) {
          var deferred = new tab._Deferred();
          deferred.reject(
            $tab__TableauException.createInvalidCustomViewName(customViewName),
          );
          return deferred.get_promise();
        }
        ...
        function WorkbookImpl$ChangeParameterValueAsync(parameterName, value) {
          ...
          if (ss.isValue(this.$parameters)) {
            if (ss.isNullOrUndefined(this.$parameters._get(parameterName))) {
              deferred.reject(
                $tab__TableauException.createInvalidParameter(parameterName),
              );
              return deferred.get_promise();
            }
          ...
          var returnHandler = new (ss.makeGenericType(
            ...
            ss.mkdel(this, function (result) {
              if (ss.isNullOrUndefined(result)) {
                deferred.reject(
                  $tab__TableauException.create("serverError", "server error"),
                );
                return;
              }
      ...
      $asm,
      {
        ...
        $getDataSourceAsync: function WorksheetImpl$GetDataSourceAsync(
          ...
          var returnHandler = new (ss.makeGenericType(
            ...
            function (result) {
              var dataSourceImpl =
                $tab__DataSourceImpl.processDataSource(result);
        ...
        $addVisualIdToCommand: function WorksheetImpl$AddVisualIdToCommand(
          ...
          if (ss.isValue(this.get_parentStoryPointImpl())) {
            ...
            if (ss.isValue(this.get_parentDashboardImpl())) {
              commandParameters["api.dashboardName"] =
        ...
        $getFilterAsync: function WorksheetImpl$GetFilterAsync(
          ...
          if (
            !$tab__Utility.isNullOrEmpty(fieldName) &&
            !$tab__Utility.isNullOrEmpty(fieldCaption)
          ) {
            throw $tab__TableauException.createInternalError(
        ...
        $applyRangeFilterAsync: function WorksheetImpl$ApplyRangeFilterAsync(
          ...
          var fixedUpFilterOptions =
            $tab__WorksheetImpl.$normalizeRangeFilterOption(options);
        ...
        $applyRelativeDateFilterAsync:
          function WorksheetImpl$ApplyRelativeDateFilterAsync(
            ...
            var fixedUpFilterOptions =
              $tab__WorksheetImpl.$normalizeRelativeDateFilterOptions(options);
        ...
        $selectMarksAsync: function WorksheetImpl$SelectMarksAsync(
          ...
          if (
            $tab__Utility.isString(fieldNameOrFieldValuesMap) &&
            ($tab__jQueryShim.isArray(valueOrUpdateType) ||
              $tab__Utility.isString(valueOrUpdateType) ||
              !$tab_$PublicEnums
                .$isValidEnum($tab_ApiSelectionUpdateType)
                .call(null, valueOrUpdateType))
          ) {
        ...
        $selectMarksWithMarksArrayAsync:
          function WorksheetImpl$SelectMarksWithMarksArrayAsync(
            ...
            for (var i = 0; i < marksArray.length; i++) {
              ...
              if (
                ss.isValue(mark.$impl.get_$tupleId()) &&
                mark.$impl.get_$tupleId() > 0
              ) {
                ...
                for (var j = 0; j < pairs.get__length(); j++) {
                  ...
                  if (
                    ...
                    !$tab__jQueryShim.isFunction(pair.fieldName) &&
                    !$tab__jQueryShim.isFunction(pair.value)
                  ) {
                    this.$parseMarksParam(
                      catNameList,
                      catValueList,
        ...
        $parseMarksParam: function WorksheetImpl$ParseMarksParam(
          ...
          if ($tab__WorksheetImpl.$regexHierarchicalFieldName.test(fieldName)) {
            ...
            if (ss.isValue(sourceOptions.nullOption)) {
              var nullOption = $tab_$PublicEnums
                .$normalizeEnum($tab_ApiNullOption)
        ...
        $selectMarksWithValuesAsync:
          function WorksheetImpl$SelectMarksWithValuesAsync(
            ...
            this.$addVisualIdToCommand(commandParameters);
            updateType = $tab_$PublicEnums
              .$normalizeEnum($tab_ApiSelectionUpdateType)
              .call(null, updateType, "updateType");
            commandParameters["api.filterUpdateType"] = updateType;
            ...
            if (
              !$tab__Utility.isNullOrEmpty(catNameList) &&
              !$tab__Utility.isNullOrEmpty(catValueList)
            ) {
            ...
            if (
              !$tab__Utility.isNullOrEmpty(hierNameList) &&
              !$tab__Utility.isNullOrEmpty(hierValueList)
            ) {
            ...
            if (
              !$tab__Utility.isNullOrEmpty(rangeNameList) &&
              !$tab__Utility.isNullOrEmpty(rangeValueList)
            ) {
            ...
            if (
              $tab__Utility.isNullOrEmpty(commandParameters["api.tupleIds"]) &&
              $tab__Utility.isNullOrEmpty(
                commandParameters["api.categoricalFieldCaption"],
              ) &&
              $tab__Utility.isNullOrEmpty(
                commandParameters["api.hierarchicalFieldCaption"],
            ...
            var returnHandler = new (ss.makeGenericType(
              ...
              ss.mkdel(this, function (result) {
                this.highlightedMarks =
                  $tab_$MarkImpl.$processActiveMarks(result);
    ...
    ss.initEnum(
      $tab_ApiSelectionUpdateType,
      $asm,
      { replace: "replace", add: "add", remove: "remove" },
      true,
    );
    ss.initEnum(
      $tab_ApiSheetSizeBehavior,
      $asm,
      {
        automatic: "automatic",
        exactly: "exactly",
    ...
    ss.initClass($tab_CrossDomainMessagingOptions, $asm, {
      ...
      sendCommand: function (T) {
        return function CrossDomainMessagingOptions$SendCommand(
          commandParameters,
          returnHandler,
        ) {
          this.$router
      ...
      $asm,
      {
        ...
        getCurrentUrlAsync: function VizImpl$GetCurrentUrlAsync() {
          ...
          var returnHandler = new (ss.makeGenericType(
            ...
            function (remoteError, message) {
              deferred.reject(
                $tab__TableauException.createInternalError(message),
              );
            },
          );
        ...
        $getNewFrameSize: function VizImpl$GetNewFrameSize() {
          ...
          if (ss.isValue(this.$initialAvailableSize)) {
            ...
            availableSize = $tab__Utility.computeContentSize(
        ...
        handleEventNotification: function VizImpl$HandleEventNotification(
          ...
          var notification =
            $tab__ApiServerNotification.deserialize(eventParameters);
          switch (eventName) {
        ...
        addEventListener: function VizImpl$AddEventListener(
          ...
          if (
            !$tab_$PublicEnums
              .$tryNormalizeEnum($tab_ApiTableauEventName)
              .call(null, eventName, normalizedEventName)
          ) {
            throw $tab__TableauException.createUnsupportedEventName(
              eventName.toString(),
            );
          }
        ...
        $create: function VizImpl$Create() {
          ...
          if (!this.$parameters.fixedSize) {
            this.$initialAvailableSize = $tab__Utility.computeContentSize(
              this.get_$parentElement(),
            );
            if (
        ...
        $sendVisibleRect: function VizImpl$SendVisibleRect() {
          ...
          var iframeContentRect =
            $tab__Utility.contentRectInDocumentCoordinates(this.get_iframe());
          var param = [];
        ...
        $getOnCheckForDoneDelegate:
          function VizImpl$GetOnCheckForDoneDelegate() {
        ...
        $handleInitialVizSize: function VizImpl$HandleInitialVizSize(
          ...
          var sheetSize = $tab_SheetSizeFactory.fromSizeConstraints(
        ...
        $removeWindowResizeHandler:
          function VizImpl$RemoveWindowResizeHandler() {
    ...
    ss.initClass($tableauSoftware_Filter, $asm, {
      ...
      $initializeFromJson: function Filter$InitializeFromJson(pm) {
        ...
        this.$fieldRole = $tab_ApiEnumConverter.convertFieldRole(
          ss.coalesce(pm.fieldRole, "unknown"),
        );
        this.$fieldAggregation = $tab_ApiEnumConverter.convertFieldAggregation(
      ...
      $asm,
      {
        ...
        $initializeFromJson$1: function RelativeDateFilter$InitializeFromJson(
          ...
          if (ss.isValue(pm.periodType)) {
            this.$periodType = $tab_ApiEnumConverter.convertPeriodType(
              ss.unbox(pm.periodType),
            );
          }
          if (ss.isValue(pm.rangeType)) {
            this.$rangeType = $tab_ApiEnumConverter.convertDateRange(
